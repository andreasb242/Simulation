 ...
 * </pre>
 * 
 * If an argument is passed, it is interpreted as an expression and evaluated.
 * Otherwise, a prompt is printed, and the user can enter expressions to be
 * evaluated.
 * 
 * <p>
 * This class has been designed to be sub classed to allow different consol
 * applications. The methods
 * 
 * <pre>
...
public class Console extends JFrame implements KeyListener {
	 ...
	 * <li>Processes the node. {@link #processEquation(Node)}
	 * <li>
	...
	public boolean processCommand(String command) {
		...
		if (!testSpecialCommands(command))
			return true;
	...
	/**
	 * Performs the required operation on a node. Typically evaluates the node
	...
	/**
	 * Prints a standard help message. Type 'quit' or 'exit' to quit, 'help' for
	 * help.
	 **/
	...
	/**
	 * Checks for special commands used by subclasses. For example a subclass
	 * may have a verbose mode switched on of off using the command
	 * 
	 * <pre>
	 * verbose on
	 * </pre>
	 ...
	 * 
	 * @param command
	 * @return true indicates normal processing should continue (default) false
	 *         if the command is special and no further processing should be
	 *         performed (parsing and evaluating)
	 * @see #split(String)
	 */
	public boolean testSpecialCommands(String command) {
		return true;
	 ...
	 * 
	 * @param e
	 * @return false if the error cannot be recovered and the program should
	 *         exit
	 */
	...
	/**
	 * Prints a line of text no newline. Subclasses should call this method
	 * rather than System.out.print to allow for output to different places.
	 * 
	 */
