...
public class DeleteUndoAction extends AbstractUndoableEdit {
	...
	public DeleteUndoAction(Vector<NamedSimulationObject> removedObjects, Vector<Connector<?>> removedConnectors, Vector<InfiniteData> removedInfinite, SimulationControl control) {
	...
	public void die() {
		...
		if(hasBeenDone) { // Gemacht, also nicht rückgängig gemacht, somit kann es nun wirklich gelöscht werden
