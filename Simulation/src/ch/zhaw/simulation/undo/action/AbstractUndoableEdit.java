...
public abstract class AbstractUndoableEdit implements UndoableEdit {
	/**
	 * Defaults to true; becomes false if this edit is undone, true again if it
	 * is redone.
	 */
	protected boolean hasBeenDone;

	/**
	 * True if this edit has not received <code>die</code>; defaults to
	 * <code>true</code>.
	 */
	 ...
	 * dequeued from an <code>UndoManager</code>.
	 */
	public void die() {
		alive = false;
	}
	...
	/**
	 * Throws <code>CannotUndoException</code> if <code>canUndo</code> returns
	 * <code>false</code>. Sets <code>hasBeenDone</code> to <code>false</code>.
	 * Subclasses should override to undo the operation represented by this
	...
	/**
	 * Returns true if this edit is <code>alive</code> and
	...
	/**
	 * Throws <code>CannotRedoException</code> if <code>canRedo</code> returns
	 * false. Sets <code>hasBeenDone</code> to <code>true</code>. Subclasses
	 * should override to redo the operation represented by this edit. Override
	...
	/**
	 * Returns <code>true</code> if this edit is <code>alive</code> and
	 * <code>hasBeenDone</code> is <code>false</code>.
	 * 
	 * @return <code>true</code> if this edit is <code>alive</code> and
	 *         <code>hasBeenDone</code> is <code>false</code>
	 * @see #die
	 * @see #undo
	 * @see #redo
	 ...
	 * <code>getRedoPresentationName</code> to construct the strings they
	 * return. Subclasses should override to return an appropriate description
	 ...
	 * <code>AbstractUndoableEdit.undoText</code> and returns that value
	 * followed by a space, followed by <code>getPresentationName</code>. If
	 * <code>getPresentationName</code> returns "", then the defaults value is
	 * returned alone.
	 * 
	 * @return the value from the defaults table with key
	 *         <code>AbstractUndoableEdit.undoText</code>, followed by a space,
	 *         followed by <code>getPresentationName</code> unless
	 *         <code>getPresentationName</code> is "" in which case, the
	...
	/**
	 * Retreives the value from the defaults table with key
	 * <code>AbstractUndoableEdit.redoText</code> and returns that value
	 * followed by a space, followed by <code>getPresentationName</code>. If
	 * <code>getPresentationName</code> returns "", then the defaults value is
	 * returned alone.
	 * 
	 * @return the value from the defaults table with key
	 *         <code>AbstractUndoableEdit.redoText</code>, followed by a space,
	 *         followed by <code>getPresentationName</code> unless
	 *         <code>getPresentationName</code> is "" in which case, the
	 *         defaults value is returned alone.
	 * @see #getPresentationName
