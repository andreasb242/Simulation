...
/**
 * Copyed and adapted from JFreeChart StandardTheme
 * 
 */
public class SimulationDiagramTheme implements ChartTheme, Cloneable, PublicCloneable, Serializable {
	...
	public static ChartTheme createJFreeTheme() {
		return new SimulationDiagramTheme("JFree");
	}
	...
	public static ChartTheme createDarknessTheme() {
		SimulationDiagramTheme theme = new SimulationDiagramTheme("Darkness");
		...
		theme.drawingSupplier = new DefaultDrawingSupplier(new Paint[] { Color.decode("0xFFFF00"), Color.decode("0x0036CC"), Color.decode("0xFF0000"),
				Color.decode("0xFFFF7F"), Color.decode("0x6681CC"), Color.decode("0xFF7F7F"), Color.decode("0xFFFFBF"), Color.decode("0x99A6CC"),
				Color.decode("0xFFBFBF"), Color.decode("0xA9A938"), Color.decode("0x2D4587") }, new Paint[] { Color.decode("0xFFFF00"),
				Color.decode("0x0036CC") }, new Stroke[] { new BasicStroke(2.0f) }, new Stroke[] { new BasicStroke(0.5f) },
	...
	protected void applyToPeriodAxis(PeriodAxis axis) {
		...
		for (int i = 0; i < info.length; i++) {
			...
			PeriodAxisLabelInfo n = new PeriodAxisLabelInfo(e.getPeriodClass(), e.getDateFormat(), e.getPadding(), this.regularFont, this.tickLabelPaint,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof SimulationDiagramTheme)) {
			return false;
		}
		SimulationDiagramTheme that = (SimulationDiagramTheme) obj;
