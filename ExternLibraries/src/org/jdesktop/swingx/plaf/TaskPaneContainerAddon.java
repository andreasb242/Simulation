...
/**
 * Addon for <code>JXTaskPaneContainer</code>. This addon defines the following
 * properties:
 * <table>
 * <tr>
 * <td>TaskPaneContainer.background</td>
 * <td>background color</td>
 * </tr>
 * <tr>
 * <td>TaskPaneContainer.backgroundPainter</td>
 * <td>background painter</td>
 * </tr>
 * <tr>
 * <td>TaskPaneContainer.border</td>
 * <td>container border</td>
 * </tr>
 * <tr>
 * <td>TaskPaneContainer.font</td>
 * <td>font (currently unused)</td>
 * </tr>
 * <tr>
 * <td>TaskPaneContainer.foreground</td>
 * <td>foreground color (currently unused)</td>
 * </tr>
 * </table>
 * 
...
public class TaskPaneContainerAddon extends AbstractComponentAddon {
	...
	protected void addWindowsDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
		...
		if (addon instanceof WindowsClassicLookAndFeelAddons) {
			...
			defaults.add("TaskPaneContainer.backgroundPainter", new PainterUIResource<JXTaskPaneContainer>(new MattePainter(new GradientPaint(0f, 0f,
	...
	protected void addMacDefaults(LookAndFeelAddons addon, DefaultsList defaults) {
		...
		defaults.add("TaskPaneContainer.background", new ColorUIResource(0xdde3eb));
		defaults.add("TaskPaneContainer.background.inactive", new ColorUIResource(0xededed));
		defaults.add(JXTaskPaneContainer.uiClassID, "org.jdesktop.swingx.plaf.macosx.MacOSXTaskPaneContainerUI");
	}
