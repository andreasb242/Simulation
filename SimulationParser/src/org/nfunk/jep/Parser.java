...
public class Parser/* @bgen(jjtree) */implements ParserTreeConstants, ParserConstants {/* @bgen (jjtree) */
	...
	final public void UnaryExpressionNotPlusMinus() throws ParseException {
		...
		default:
			...
			if (jj_2_7(2147483647)) {
				ArrayAccess();
			} else if ((getToken(1).kind == INDENTIFIER1 || getToken(1).kind == INDENTIFIER2) && jep.funTab.containsKey(getToken(1).image)) {
				Function();
			} else {
				switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
				case INDENTIFIER1:
	...
	final private boolean jj_3R_23() {
		...
		if (jj_3R_28()) {
			...
			if (jj_3R_29()) {
				jj_scanpos = xsp;
				lookingAhead = true;
				jj_semLA = (getToken(1).kind == INDENTIFIER1 || getToken(1).kind == INDENTIFIER2) && jep.funTab.containsKey(getToken(1).image);
				lookingAhead = false;
	...
	private static void jj_la1_0() {
		jj_la1_0 = new int[] { 0x80001, 0x80001, 0x80001, 0x10000000, 0x8000000, 0x4800000, 0x4800000, 0x3600000, 0x3600000, 0x60000000, 0x60000000,
				0x80000000, 0x60000000, 0x0, 0xa80, 0x9000, 0x100000, 0x9000, 0x100000, 0x9000, 0xa80, 0x280, };
	}
