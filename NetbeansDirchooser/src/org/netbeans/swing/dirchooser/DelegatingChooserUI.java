...
/**
 * Placeholder ComponentUI that just delegates to other FileChooserUIs based on
 * what selection mode is set in JFileChooser.
 * 
 * @author Dafe Simonek
 */
public class DelegatingChooserUI extends ComponentUI {
	...
	public static ComponentUI createUI(JComponent c) {
		...
		// #109703 - don't use shell folder on JDK versions interval <1.6.0_02,
		// 1.6.0_10>,
		...
		// mark start time, just once during init (code can be run multiple
		// times because of property listenign below)
	...
	private static Class<?> getCurChooser(JFileChooser fc) {
		...
		return FolderChooserUi.getOrigChooser();
	}
