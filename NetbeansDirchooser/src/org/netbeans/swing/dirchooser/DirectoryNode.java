...
public class DirectoryNode extends DefaultMutableTreeNode {
	...
	public boolean loadChildren(JFileChooser chooser, boolean descend) {
		...
		if (loaded == false) {
			...
			ArrayList<File> files = getFiles(chooser);
	...
	private ArrayList<File> getFiles(JFileChooser chooser) {
		// fixed bug #97124
		ArrayList<File> list = new ArrayList<File>();

		// Fix for IZ#116859 [60cat] Node update bug in the "open project" panel
		// while deleting directories
