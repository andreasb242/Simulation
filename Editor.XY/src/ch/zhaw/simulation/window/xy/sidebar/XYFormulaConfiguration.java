...
public abstract class XYFormulaConfiguration extends ConfigurationSidebarPanel {
	...
	public XYFormulaConfiguration(AbstractSimulationModel<?> model,SelectionModel selectionModel) {
		...
		//
		// SubmodelComboboxModel cbModel = new
		// SubmodelComboboxModel(model.getSubmodels());
