...
public class Determinant extends PostfixMathCommand implements UnaryOperatorI {
	...
	public MatrixValueI calcValue(MatrixValueI res, MatrixValueI lhs) throws ParseException {
		...
		if (mat.getNumRows() == 2) {
			res.setEle(0, sub.sub(mul.mul(mat.getEle(0, 0), mat.getEle(1, 1)), mul.mul(mat.getEle(1, 0), mat.getEle(0, 1))));
	...
	private static Object[][] dropRowCol(Object[][] mat, int xrow, int xcol) {
	...
	/**
	 * Calculates the determinant of an array Uses the fact that
	 * 
	 * <pre>
	 * | a b c |
	 ...
	 * </pre>
	 */
	private Object det(Object[][] mat) throws ParseException {
		if (mat.length == 1)
			return mat[0][0];
		if (mat.length == 2) {
