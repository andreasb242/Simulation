...
public class MatrixPreprocessor implements ParserVisitor {
	 ...
	 */
	protected MatrixNodeI preprocess(Node node, MatrixJep mdjep) throws ParseException {
		this.mjep = mdjep;
	...
	/** operators +,-,*,/ **/
	private Object visitOp(ASTFunNode node, Object data) throws ParseException {
		PostfixMathCommandI pfmc = node.getPFMC();
		MatrixNodeI children[] = visitChildrenAsArray(node, data);
