...
public class MatrixNodeFactory extends NodeFactory {
	...
	protected MatrixNodeFactory(XJep xj) {
		super(xj);
	}
	 ...
	 */
	private Dimensions calcDim(String name, PostfixMathCommandI pfmc, Node arguments[]) throws ParseException {
	 ...
	 * Calculates the dimension of node using the dimensions of the children.
	 */
	private Dimensions calcDim(Operator op, Node arguments[]) throws ParseException {
