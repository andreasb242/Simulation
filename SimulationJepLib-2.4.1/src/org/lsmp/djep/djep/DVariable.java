...
public class DVariable extends XVariable {
	protected Hashtable<String, PartialDerivative> derivatives = new Hashtable<String, PartialDerivative>();
	...
	public void invalidateAll() {
		...
		for (PartialDerivative deriv : derivatives.values()) {
	 ...
	 */
	protected static String makeDerivString(String rootname, String dnames[]) {
	 ...
	 */
	private void setDerivative(String derivnames[], PartialDerivative eqn) {
	...
	private PartialDerivative getDerivativeSorted(String derivnames[]) {
	 ...
	 */
	private PartialDerivative findDerivativeSorted(String derivnames[], DJep jep) throws ParseException {
		if (getEquation() == null)
			return null;
	...
	private PartialDerivative findDerivative(String derivnames[], DJep jep) throws ParseException {
		String newnames[] = sortedNames(derivnames);
	 ...
	 */
	public Enumeration<PartialDerivative> allDerivatives() {
