...
public class MacroDiffRules extends ChainRuleDiffRules {
	 ...
	 * @throws ParseException
	 */
	private MacroDiffRules(DJep djep, String inName, PostfixMathCommandI inPfmc, String rule) throws ParseException {
		// super(dv);
		name = inName;
		pfmc = inPfmc;
		if (pfmc != null) {
	 ...
	 * @throws ParseException
	 */
	private MacroDiffRules(DJep djep, String inName, PostfixMathCommandI inPfmc, String rule1, String rule2) throws ParseException {
		name = inName;
		pfmc = inPfmc;
		if (pfmc != null) {
			int nParam = pfmc.getNumberOfParameters();
	 ...
	 * @throws ParseException
	 */
	private MacroDiffRules(DJep djep, String inName, PostfixMathCommandI inPfmc, String[] inRules) throws ParseException {
		name = inName;
		pfmc = inPfmc;
		if (pfmc != null) {
			int nParam = pfmc.getNumberOfParameters();
