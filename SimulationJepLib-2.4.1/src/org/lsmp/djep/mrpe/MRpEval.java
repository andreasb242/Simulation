...
public final class MRpEval implements ParserVisitor {
	...
	private static final short VLIST = 21;
	private static final short MLIST = 22;
	...
	private static final Hashtable<String, Short> functionHash = new Hashtable<String, Short>();
	{
	...
	private abstract static class ObjStore implements Observer {
		...
		Hashtable<Variable, Object> varRefs = new Hashtable<Variable, Object>();
		/** The stack pointer */
		int sp = 0;
	...
	private final class M33Store extends MatStore {
		...
		final void eq() {
			M33Obj r = stack[--sp];
			M33Obj l = stack[--sp];
			if (l.a == r.a && l.b == r.b && l.c == r.c && l.d == r.d && l.e == r.e && l.f == r.f && l.g == r.g && l.h == r.h && l.i == r.i)
				scalerStore.stack[scalerStore.sp++] = 1.0;
			else
				scalerStore.stack[scalerStore.sp++] = 0.0;
		}
	...
	private final class M34Store extends MatStore {
		...
		final void eq() {
			M34Obj r = stack[--sp];
			M34Obj l = stack[--sp];
			if (l.a == r.a && l.b == r.b && l.c == r.c && l.d == r.d && l.e == r.e && l.f == r.f && l.g == r.g && l.h == r.h && l.i == r.i && l.j == r.j
					&& l.k == r.k && l.l == r.l)
				scalerStore.stack[scalerStore.sp++] = 1.0;
			else
				scalerStore.stack[scalerStore.sp++] = 0.0;
	...
	private final class M44Store extends MatStore {
		...
		final void eq() {
			...
			M44Obj l = stack[--sp];
			if (l.a == r.a && l.b == r.b && l.c == r.c && l.d == r.d && l.e == r.e && l.f == r.f && l.g == r.g && l.h == r.h && l.i == r.i && l.j == r.j
					&& l.k == r.k && l.l == r.l && l.m == r.m && l.n == r.n && l.o == r.o && l.p == r.p)
				scalerStore.stack[scalerStore.sp++] = 1.0;
			else
				scalerStore.stack[scalerStore.sp++] = 0.0;
		}
	...
	private final void addConstant(Object obj) throws ParseException {
		double val;
