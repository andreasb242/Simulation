 ...
 */
abstract class AbstractPNode implements PNodeI {
	/** A reference to the PolynomialCreator instance. */
	protected PolynomialCreator pc;

	protected AbstractPNode(PolynomialCreator pc) {
		this.pc = pc;
	}
	...
	public PNodeI mul(PNodeI node) throws ParseException {
		...
		if (this.compareTo(node) < 0)
			return new Monomial(pc, pc.oneConstant, new PNodeI[] { this, node }, new PNodeI[] { pc.oneConstant, pc.oneConstant });
