...
public class MutiableMonomial {
	...
	private PConstant coeff;
	private int length;
	private PNodeI terms[];
	private PNodeI powers[];

	/**
	 * Note arrays parsed may be modified.
	 */
	protected MutiableMonomial(PolynomialCreator pc, PConstant coeff, PNodeI nodes[], PNodeI pows[]) {
		this.pc = pc;
		this.coeff = coeff;
		length = nodes.length;
		terms = nodes;
