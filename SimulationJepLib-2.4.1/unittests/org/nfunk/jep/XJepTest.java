...
/**
 * @author Rich Morris Created on 17-Apr-2005
 */
public class XJepTest extends JepTest {
	...
	public void testVarInEqn() throws Exception {
		...
		Vector<?> v = xj.getVarsInEquation(n1, new Vector<Variable>());
		...
		Vector<?> v2 = xj.recursiveGetVarsInEquation(n2, new Vector<XVariable>());
	...
	public void testBad() throws Exception {
		if (SHOW_BAD) {
			...
			simplifyTest("diff(re(x+i y),x)", "1"); // not smart enough to work
			// out re(i) = 1
