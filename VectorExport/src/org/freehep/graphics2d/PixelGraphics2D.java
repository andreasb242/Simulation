...
public class PixelGraphics2D extends AbstractVectorGraphics {
	...
	public boolean drawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2, int sy2, Color bgcolor, ImageObserver observer) {
		return hostGraphics.drawImage(img, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, getPrintColor(bgcolor), observer);
	}
	...
	public void drawSymbol(double x, double y, double size, int symbol) {
		...
		if ((intSize > MAX_BLIT_SIZE) || (lineWidth != 1.0) || !isDisplayLocal()
